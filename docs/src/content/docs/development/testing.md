...
Jasmine tests are run on [Travis CI](https://travis-ci.org/github/conversejs/converse.js).
...
the [spec](https://github.com/jcbrand/converse.js/blob/master/spec/) directory.
