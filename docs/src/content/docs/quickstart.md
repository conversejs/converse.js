...
```html
<link rel="stylesheet" href="https://cdn.conversejs.org/14.0.0-beta.1/dist/converse.min.css">
<script type="module" src="https://cdn.conversejs.org/14.0.0-beta.1/dist/converse.min.js"></script>
```
