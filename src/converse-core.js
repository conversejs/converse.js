            ...
            if (!this.connection) {
                if (this.use_xep_0156) {
                    ...
                    xhr.onload = function(evt) {
                        if (xhr.status >= 200 && xhr.status < 400) {
                            ...
                            if (('WebSocket' in window || 'MozWebSocket' in window) && _converse.websocket_url)
                                ...
                                throw new Error("initConnection: neither BOSH nor WebSocket connection methods have been specified with XEP-0156.");
                    ...
                    xhr.onerror = function () {
                        ...
                        //_converse.emit('connectionNotInitialized');
                    };
                    return xhr.send();
                } else {
