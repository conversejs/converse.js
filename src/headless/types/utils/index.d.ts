...
declare const _default: {
    ...
    webForm2xForm(field: HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement): Element;
    getCurrentWord(input: HTMLInputElement, index?: number, delineator?: string): string;
