...
describe('A Chat Message', function () {
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function (_converse) {
            ...
            await _converse.handleMessageStanza(
                mock.createChatMessage(_converse, contact_jid, 'This message will be read'),
            );
            await u.waitUntil(
                () =>
                    view.querySelector('converse-chat-message .chat-msg__text')?.textContent ===
            ...
            await _converse.handleMessageStanza(
                mock.createChatMessage(_converse, contact_jid, 'This message will be new'),
            );
            ...
            await u.waitUntil(
                () =>
                    view.querySelector('converse-chat-message:last-child .chat-msg__text')?.textContent ===
    ...
    it(
        ...
        mock.initConverse([], {}, async function (_converse) {
            ...
            expect(el.parentElement.nextElementSibling.querySelector('.chat-msg__text').textContent).toEqual(
                'another in between message',
            );
            el = sizzle('.chat-msg:eq(2)', view).pop();
            expect(el.querySelector('.chat-msg__text').textContent).toEqual('another in between message');
            ...
            expect(day.nextElementSibling.querySelector('.chat-msg__text').textContent).toBe(
        ...
        describe('and for which then an error message is received from the server', function () {
            it(
                ...
                mock.initConverse(['chatBoxesFetched'], {}, async function (_converse) {
                    ...
                    await u.waitUntil(
                        () => view.querySelector('.chat-msg__error')?.textContent.trim() === ui_error_txt,
                    );
                    ...
                    await u.waitUntil(
                        () =>
                            view
                                .querySelector('converse-chat-message:last-child .chat-msg__error')
                                ?.textContent.trim() === ui_error_txt,
                    );
                    ...
                    await u.waitUntil(
                        () =>
                            sizzle('converse-chat-message:last-child .chat-msg__text', view).pop()?.textContent ===
                            msg_text,
                    );
                    ...
                    await u.waitUntil(
                        () => !view.model.messages.models.reduce((acc, m) => acc || m.get('editable'), false),
                        1000,
                    );
