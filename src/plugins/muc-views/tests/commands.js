    ...
    describe('Each chat groupchat can take special commands', function () {
            ...
            mock.initConverse(converse, [], {}, async function (_converse) {
                ...
                iq_stanza = await u.waitUntil(() =>
                    _converse.api.connection
                        ...
                        .IQ_stanzas.filter((iq) =>
                            iq.querySelector('iq[to="lounge@muc.montague.lit"][type="get"] item[affiliation="member"]'),
                        )
                        .pop(),
                );
                ...
                iq_stanza = await u.waitUntil(() =>
                    _converse.api.connection
                        .get()
                        .IQ_stanzas.filter((iq) =>
                            iq.querySelector('iq[to="lounge@muc.montague.lit"][type="get"] item[affiliation="owner"]'),
                        )
                        .pop(),
                );
                ...
                iq_stanza = await u.waitUntil(() =>
                    _converse.api.connection
                        .get()
                        .IQ_stanzas.filter((iq) =>
                            iq.querySelector('iq[to="lounge@muc.montague.lit"][type="get"] item[affiliation="admin"]'),
                        )
                        .pop(),
                );
        ...
        it(
            ...
            mock.initConverse(converse, [], {}, async function (_converse) {
                ...
                await u.waitUntil(
                    () =>
                        view.querySelector('.message:last-child')?.textContent?.trim() ===
                ...
                expect(view.querySelectorAll('.chat-info__message')[1].textContent.trim()).toBe(
        ...
        it(
            ...
            mock.initConverse(converse, [], {}, async function (_converse) {
                ...
                expect(sent_IQ)
                    .toEqualStanza(stx`<iq id="${IQ_id}" to="lounge@montague.lit" type="set" xmlns="jabber:client">
                    <query xmlns="http://jabber.org/protocol/muc#admin">
        ...
        it(
            ...
            mock.initConverse(converse, [], {}, async function (_converse) {
                ...
                await u.waitUntil(() =>
                    view
                        .querySelector('.chat-content__notifications')
                        .textContent.includes('annoyingGuy has been muted'),
                );
                ...
                await u.waitUntil(() =>
                    view
                        .querySelector('.chat-content__notifications')
                        .textContent.includes('annoyingGuy has been given a voice'),
                );
            }),
        );

        it(
            'takes /destroy to destroy a muc',
            mock.initConverse(converse, [], {}, async function (_converse) {
                const muc_jid = 'lounge@montague.lit';
