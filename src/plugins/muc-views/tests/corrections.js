...
describe('A Groupchat Message', function () {
    ...
    it(
        ...
        mock.initConverse([], {}, async function (_converse) {
            ...
            expect(older_msgs[1].textContent.includes('But soft, what light through yonder chimney breaks?')).toBe(
                true,
            );
        }),
    );
    ...
    it(
        ...
        mock.initConverse([], {}, async function (_converse) {
            ...
            await u.waitUntil(
                () =>
                    view.querySelectorAll('.chat-msg__text')[0].textContent ===
                    'But soft, what light through yonder window breaks?',
                500,
            );
            ...
            await u.waitUntil(
                () =>
                    view.querySelectorAll('.chat-msg__text')[2].textContent ===
                    'But soft, what light through yonder window breaks?',
                500,
            );
