        ...
        describe('A composing notification', function () {
            it(
                ...
                mock.initConverse([], {}, async function (_converse) {
                    ...
                    expect(view.querySelector('.chat-content__notifications').textContent.trim()).toEqual(
                        'newguy is typing',
                    );
                    ...
                    await u.waitUntil(
                        () =>
                            view.querySelector('.chat-content__notifications').textContent.trim() ===
                            'newguy and nomorenicks are typing',
                        1000,
                    );
                    ...
                    await u.waitUntil(
                        () =>
                            view.querySelector('.chat-content__notifications').textContent.trim() ===
                            'newguy, nomorenicks and majortom are typing',
                        1000,
                    );
                    ...
                    await u.waitUntil(
                        () =>
                            view.querySelector('.chat-content__notifications').textContent.trim() ===
                            'newguy, nomorenicks and others are typing',
                        1000,
                    );
                    ...
                    await u.waitUntil(
                        () =>
                            view.querySelector('.chat-content__notifications').textContent.trim() ===
                            'nomorenicks, majortom and groundcontrol are typing',
                        1000,
                    );
                }),
            );
