...
describe('An incoming groupchat message', function () {
    ...
    it(
        ...
        mock.initConverse([], {}, async function (_converse) {
            ...
            const msg = await u.waitUntil(() =>
                sent_stanzas.filter((s) => s.nodeName.toLowerCase() === 'message').pop(),
            );
            ...
            expect(message.innerHTML.replace(/<!-.*?->/g, '')).toBe(
                'hello <span class="mention" data-uri="xmpp:lounge@montague.lit/ThUnD3r%7CGr33n">ThUnD3r|Gr33n</span>',
            );
        }),
    );
    ...
    describe('in which someone is mentioned', function () {
        it(
            ...
            mock.initConverse([], {}, async function (_converse) {
                ...
                expect(references).toEqual([
                    { 'begin': 3, 'end': 8, 'value': 'robot', 'type': 'mention', 'uri': 'xmpp:robot@montague.lit' },
                ]);
                ...
                expect(references).toEqual([
                    {
                        ...
                        'value': 'gh0st',
                        'type': 'mention',
                        'uri': 'xmpp:lounge@montague.lit/gh0st',
                    },
                ]);
                ...
                expect(text).toBe('hello z3r0');
                expect(references).toEqual([
                    { 'begin': 6, 'end': 10, 'value': 'z3r0', 'type': 'mention', 'uri': 'xmpp:z3r0@montague.lit' },
                ]);
                ...
                expect(references).toEqual([
                    { 'begin': 13, 'end': 17, 'value': 'z3r0', 'type': 'mention', 'uri': 'xmpp:z3r0@montague.lit' },
                    { 'begin': 18, 'end': 24, 'value': 'gibson', 'type': 'mention', 'uri': 'xmpp:gibson@montague.lit' },
                    {
                        ...
                        'value': 'mr.robot',
                        'type': 'mention',
                        'uri': 'xmpp:mr.robot@montague.lit',
                    },
                ]);
                ...
                expect(references.length).toBe(1);
                expect(references).toEqual([
                    { 'begin': 0, 'end': 6, 'value': 'gibson', 'type': 'mention', 'uri': 'xmpp:gibson@montague.lit' },
                ]);
                ...
                expect(references).toEqual([
                    {
                        ...
                        'value': 'Link Mauve',
                        'type': 'mention',
                        'uri': 'xmpp:Link-Mauve@montague.lit',
                    },
                ]);
                ...
                expect(references.length).toBe(1);
                expect(references).toEqual([
                    { 'begin': 8, 'end': 14, 'value': 'gibson', 'type': 'mention', 'uri': 'xmpp:gibson@montague.lit' },
                ]);
        ...
        it(
            ...
            mock.initConverse([], {}, async function (_converse) {
                ...
                await u.waitUntil(
                    () =>
                        view.querySelector('.chat-msg__text').textContent ===
