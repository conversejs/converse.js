...
describe('A XEP-0316 MEP notification', function () {
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function (_converse) {
            ...
            expect(
                view
                    .querySelector('converse-chat-message:last-child .chat-info__message converse-texture')
                    .textContent.trim(),
            ).toBe(msg);
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function (_converse) {
            ...
            expect(
                view
                    .querySelector('.reason converse-texture')
                    .innerHTML.replace(/<!-.*?->/g, '')
                    .trim(),
            ).toBe(
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function (_converse) {
            ...
            expect(view.querySelector('.reason').textContent.trim()).toBe(reason);
            await u.waitUntil(() =>
                view.querySelector('converse-message-actions converse-dropdown .chat-msg__action-retract'),
            );
