        ...
        it(
            ...
            mock.initConverse(
                ...
                async function (_converse) {
                    ...
                    await mock.setComposerText(view, '/register');
                    ...
                    let stanza = await u.waitUntil(() =>
                        _converse.api.connection
                            ...
                            .IQ_stanzas.filter(
                                (iq) =>
                                    sizzle(`iq[to="${muc_jid}"][type="get"] query[xmlns="jabber:iq:register"]`, iq)
                                        .length,
                            )
                            .pop(),
                    );
                ...
                <iq from="${view.model.get('jid')}"
                    ...
                    stanza = await u.waitUntil(() =>
                        _converse.api.connection
                            ...
                            .IQ_stanzas.filter(
                                (iq) =>
                                    sizzle(`iq[to="${muc_jid}"][type="set"] query[xmlns="jabber:iq:register"]`, iq)
                                        .length,
                            )
                            .pop(),
                    );
