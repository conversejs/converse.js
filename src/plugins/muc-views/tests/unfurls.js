...
describe('A Groupchat Message', function () {
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function (_converse) {
            ...
            const unfurl_url =
                'https://github.com/conversejs/converse.js/commit/b7b14601773e63ede3f93c47550fdc317553a04a';
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function (_converse) {
            ...
            expect(unfurl.querySelector('.card-img-top').getAttribute('src')).toBe(
                'https://conversejs.org/dist/images/custom_emojis/converse.png',
            );
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], { render_media: false }, async function (_converse) {
            ...
            let button = await u.waitUntil(() =>
                view.querySelector('.chat-msg__content .chat-msg__action-hide-previews'),
            );
    ...
    it(
        ...
        mock.initConverse(['chatBoxesFetched'], {}, async function (_converse) {
            ...
            expect(view.querySelector('.chat-msg--retracted .retraction').textContent.trim()).toBe(
                'arzu has removed a message',
            );
        }),
    );
