...
/**
 * @typedef {Object} XMPPProvider
 * @property {string} jid
 * @property {string} category
 * @property {number} [ratingXmppComplianceTester]
 * @property {boolean} [freeOfCharge]
 * @property {boolean} [inBandRegistration]
 * @property {Object} [registrationWebPage]
 * @property {boolean} [professionalHosting]
 * @property {string[]} [serverLocations]
 * @property {string} [since]
 * @property {string} [serverSoftwareName]
 * @property {string} [organization]
 * @property {Object} [passwordReset]
 * @property {Object} [legalNotice]
 * @property {number} [maximumHttpFileUploadFileSize]
 * @property {number} [maximumHttpFileUploadStorageTime]
 * @property {number} [maximumMessageArchiveManagementStorageTime]
 */
 ...
 * @returns {Promise<XMPPProvider[]>} - Array of provider objects
 */
