    ...
    describe('Integration of Roster Items and Presence Subscriptions', function () {
        ...
        it(
            ...
            mock.initConverse(
                converse,
                [],
                { show_self_in_roster: false, roster_groups: false },
                async function (_converse) {
                    ...
                    const roster_set_stanza = IQ_stanzas.filter((s) =>
                        sizzle('query[xmlns="jabber:iq:roster"]', s),
                    ).pop();
                    ...
                    expect(sent_presence).toEqualStanza(stx`
                        <presence to="contact@example.org" type="subscribe" xmlns="jabber:client">
                            ...
                            <c hash="sha-1"
                                ...
                                ver="vLJbOCGqqjP24VHL6kYiv2RbtZQ="
                    ...
                    await u.waitUntil(() => {
                        ...
                        const contacts = Array.from(header?.parentElement.querySelectorAll('li') ?? []).filter(
                            u.isVisible,
                        );
