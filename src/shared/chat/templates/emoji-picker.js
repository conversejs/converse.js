...
function tplEmojiPickerHeader(o) {
    ...
    return html`
        <span ?hidden=${!o.query} class="emoji-lists__container emojis-lists__container--search">
            ...
            <ul class="emoji-picker">
                ${o.search_results.map((emoji) => tplEmojiItem(Object.assign({ emoji }, o)))}
            </ul>
        </span>
    `;
}
...
async function tplEmojisForCategory(o) {
    ...
    return html`<a id="emoji-picker-${o.category}" class="emoji-category__heading" data-category="${o.category}"
        ...
        <ul class="emoji-picker" data-category="${o.category}">
            ${Object.values(emojis ?? {}).map((emoji) => tplEmojiItem(Object.assign({ emoji }, o)))}
        </ul>`;
}
...
export function tplEmojiPicker(el, o) {
    ...
    return html` <div class="emoji-picker__header">
            <input
            ...
            />
            ${o.query ? '' : tplEmojiPickerHeader(o)}
        </div>
        ${o.render_emojis
        ...
        <div class="emoji-skintone-picker">
            Skin tone:
            <ul>
                ${Object.keys(skintones).map((k) => tplSkintoneEmoji(o, k, skintones[k]))}
            </ul>
        </div>`;
}
