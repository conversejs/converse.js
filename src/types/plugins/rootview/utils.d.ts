 ...
 * property in the same CSS rule that carries its colours. Converse therefore
 * doesn't need to know a theme's name to know how dark it is, and a
 * third-party theme gets the same treatment as a bundled one.
 *
