...
declare const renderTexture: (text: string, offset: number, options: any, callback?: Function) => import("lit-html/directive.js").DirectiveResult<typeof TextureDirective>;
