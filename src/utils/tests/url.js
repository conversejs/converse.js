...
const { isDomainWhitelisted, isDomainAllowed, shouldRenderMediaFromURL } = converse.env.utils;
...
describe('URL Utility Functions', () => {
    ...
    describe('isDomainAllowed', () => {
        it(
            'should return true when setting is not an array',
            mock.initConverse(
                converse,
                ['chatBoxesFetched'],
        ...
        it(
            'should return false for non-allowed domain',
            mock.initConverse(
                converse,
                ['chatBoxesFetched'],
                { 'allowed_video_domains': ['conversejs.org'] },
    ...
    describe('shouldRenderMediaFromURL', () => {
        it(
            'should allow http/https protocols',
            mock.initConverse(
                converse,
                ['chatBoxesFetched'],
                { allowed_image_domains: ['conversejs.org'] },
                function (_converse) {
        ...
        it(
            'should allow chrome-extension and file protocols',
            mock.initConverse(
                converse,
                ['chatBoxesFetched'],
                { allowed_image_domains: ['conversejs.org'] },
